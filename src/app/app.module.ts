...
import { TooltipModule } from 'ng2-tooltip-directive';  // https://www.npmjs.com/package/ng2-tooltip-directive
...
// tslint:disable-next-line:max-line-length
// import { FroalaEditorModule, FroalaViewModule } from 'angular-froala-wysiwyg';  // https://github.com/froala/angular-froala-wysiwyg  && https://www.npmjs.com/package/froala-editor
...
@NgModule({
  declarations: [
    ...
    SearchProjectsByCategoryVisitorComponent,
    SearchProjectsVisitorComponent,
    ShowAllCategoryProjectsVisitorComponent,
